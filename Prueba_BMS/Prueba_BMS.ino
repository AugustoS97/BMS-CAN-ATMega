/*
   ...
   NOMBRE: SMART BMS
   VERSIÓN: V.1.0
   DESCRIPCIÓN: FIRMWARE DEL MICROCONTROLADOR ALOJADO EN LA PCB DEL BMS. SU FUNCIÓN ES MONITORIZAR LA TENSIÓN DE LAS CELDAS, LA TEMPERATURA, EL SOH Y EL SOC Y ENVIAR VÍA
   CAN BUS DICHA INFORMACIÓN ASÍ COMO UN MENSAJE DE ALERTA TANTO CUANDO LA BATERÍA ESTÁ TOTALMENTE CARGADA COMO CUANDO ESTÁ AL MÍNIMO Y DEBEN DESCONECTARSE LOS SISTEMAS
   QUE CONSUMEN
*/
#include "config.h"
#include "Arduino.h"
